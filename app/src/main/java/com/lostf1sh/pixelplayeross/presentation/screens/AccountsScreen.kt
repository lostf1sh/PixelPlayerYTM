...
fun AccountsScreen(
    onBackClick: () -> Unit,
    @Suppress("UNUSED_PARAMETER") viewModel: AccountsViewModel = hiltViewModel()
) {
            ...
            item {
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.presentation_batch_b_accounts_no_linked_title),
                            style = MaterialTheme.typography.titleLarge,
                            fontWeight = FontWeight.Bold
                        )
                        Text(
                            text = stringResource(R.string.presentation_batch_b_accounts_no_linked_body),
