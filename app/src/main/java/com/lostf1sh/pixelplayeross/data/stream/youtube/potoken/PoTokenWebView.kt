...
/**
 * Runs YouTube's BotGuard challenge inside a headless [WebView] (loading the bundled
 * `po_token.html`) and mints PoTokens. Ported from Metrolist/NewPipe; adapted to this app's
 * package with no upstream proxy.
 */
class PoTokenWebView private constructor(
    ...
    fun onObtainPoTokenResult(identifier: String, poTokenU8: String) {
        Timber.tag(TAG).d("Generated poToken (before decoding): identifier=$identifier")
        val poToken = try {
